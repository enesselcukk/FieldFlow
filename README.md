...
If no open-source license file is present in this repository, clarify terms of use with the project owner.

---

*This README was produced from `build.gradle.kts`, `settings.gradle.kts`, `gradle/libs.versions.toml`, `AndroidManifest.xml`, and navigation sources in the repo. When dependency versions change, update the tables from `libs.versions.toml` first.*
